...
namespace CafeWorkspaceBooking.Migrations
{
    ...
    [Migration("20240220060145_addCL_TgianThongbao")]
    partial class addCL_TgianThongbao
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CafeWorkspaceBooking.Models.AppThongBao", b =>
                {
                    ...
                    b.HasIndex("IdDanhGia")
                        .IsUnique()
                        .HasFilter("[IdDanhGia] IS NOT NULL");

                    b.HasIndex("IdDatPhong")
                        .IsUnique()
                        .HasFilter("[IdDatPhong] IS NOT NULL");
            ...
            modelBuilder.Entity("CafeWorkspaceBooking.Models.AppThongBao", b =>
                {
                    b.HasOne("CafeWorkspaceBooking.Models.AppDanhGia", "appDanhGia")
                        .WithOne("appThongBao")
                        .HasForeignKey("CafeWorkspaceBooking.Models.AppThongBao", "IdDanhGia");

                    b.HasOne("CafeWorkspaceBooking.Models.AppDatPhong", "appDatPhong")
                        .WithOne("appThongBao")
                        .HasForeignKey("CafeWorkspaceBooking.Models.AppThongBao", "IdDatPhong")
                    ...
                    b.HasOne("CafeWorkspaceBooking.Models.AppKhachHang", "appKhachHang")
                        .WithOne("appThongBao")
                        .HasForeignKey("CafeWorkspaceBooking.Models.AppThongBao", "IdKhachHang");

                    b.HasOne("CafeWorkspaceBooking.Models.AppPhong", "appPhong")
                        .WithOne("appThongBao")
                        .HasForeignKey("CafeWorkspaceBooking.Models.AppThongBao", "IdPhong")
                        .OnDelete(DeleteBehavior.NoAction);
